...
Call
[`roxygen2md::roxygen2md()`](https://roxygen2md.r-lib.org/reference/roxygen2md.md)
...
review. After this
[`find_rd()`](https://roxygen2md.r-lib.org/reference/find_rd.md) shows
remaining Rd format artifacts that were not handled by the conversion.
...
The [`find_rd()`](https://roxygen2md.r-lib.org/reference/find_rd.md)
